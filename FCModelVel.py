...
train_data = FCDataset('./data/TrainingDataVel.csv',seq_len=sequence_length, n_input_feat=num_input_feature*num_tracker, n_output=num_output)
trainloader = DataLoader(train_data, batch_size=batch_size, shuffle=True, drop_last=True, num_workers=8, pin_memory=False)

train_data_not_mixed = FCDataset('./data/TrainingDataOCSVMVel.csv',seq_len=sequence_length, n_input_feat=num_input_feature*num_tracker, n_output=num_output)
...
validation_data = FCDataset('./data/ValidationDataVel.csv',seq_len=sequence_length, n_input_feat=num_input_feature*num_tracker, n_output=num_output)
...
test_data = FCDataset('./data/TestingDataVel.csv',seq_len=sequence_length, n_input_feat=num_input_feature*num_tracker, n_output=num_output)
testloader = DataLoader(test_data, batch_size=batch_size, shuffle=False, drop_last=True, num_workers=8, pin_memory=False)

test_operating_data = FCDataset('./data/TestingOperatingDataVel.csv',seq_len=sequence_length, n_input_feat=num_input_feature*num_tracker, n_output=num_output)
...
np.savetxt('./result/tracker_real_vel.csv',tracker_real_arr)
np.savetxt('./result/tracker_prediction_vel.csv',tracker_pred_arr)
...
np.savetxt('./result/tracker_operating_real_vel.csv',tracker_real_operating_arr)
np.savetxt('./result/tracker_operating_prediction_vel.csv',tracker_pred_operating_arr)
...
np.savetxt('./result/tracker_ocsvm_training_data_prediction_vel.csv',residual_arr)